      ...
      <div class="card col-md-10 my-sm-2" style="max-width: 550px;">
        <div class="row">
          ...
          @if(!empty($sport->user->img_name))
            <div class='image-small'><img src="{{ asset($sport->user->img_name) }}" class="card-img rounded-circle img-responsive" style="max-width: 100%; alt=""> </div>
          @else
            <div class='image-small'><img src="{{ Gravatar::src($sport->user->email, 500) }}" class="card-img rounded-circle" alt=""></div>
          @endif
